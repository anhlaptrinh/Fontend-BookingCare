...
class Header extends Component {
  ...
  render() {
    let thislanguage=this.props.language
    return (
        ...
        <div className="home-header-container">
          <div className="home-header-content">
            ...
            <div className="right-content">
              ...
              <div className={thislanguage===languages.VI?"language-vi active":"language-vi"}><span onClick={()=>{this.changeLanguage(languages.VI)}}>VN</span></div>
              <div className={thislanguage===languages.EN?"language-en active":"language-en"}><span onClick={()=>{this.changeLanguage(languages.EN)}}>EN</span></div>
            </div>
          </div>
        </div>
          ...
          <div className="content-down">
            <div className="options">
              ...
              <div className="option-child">
                ...
                <div className="text-child text-p2">
              ...
              <div className="option-child">
                ...
                <div className="text-child text-p6">
              ...
              <div className="option-child">
                ...
                <div className="text-child text-p4">
